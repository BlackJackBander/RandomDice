Вот окончательный код, который генерирует 110 бросков, использует первые 100 для обучения ARIMAX модели, а затем сравнивает прогноз на последние 10 бросков с реальными значениями:
